...
Pod::Spec.new do |s|
  ...
  s.name         = "CJZAToolKits"
  s.version      = "0.2.6"
  s.summary      = "A short description of CJZAToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CJZAToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CJZAToolKits.git", :tag => "#{s.version}" }
